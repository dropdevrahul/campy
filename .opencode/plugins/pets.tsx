...
const robotFrames: Record<PetState, string[][]> = {
  ...
  eating: [
    pad([" \\o/  ___  ___  \\o/ ","  │  | ◉ |---| ◉ |  │ ","  └─┘ |___/   \\___| └─┘","     nom nom !        "], W),
    pad([" \\o/  ___  ___  \\o/ ","  │  | ◉ |---| ◉ |  │ ","  └─┘ |___/   \\___| └─┘","      nom !           "], W),
  ],
  playing: [
    pad([" \\o/  ___  ___  \\o/ ","  │  | ω |---| ω |  │ ","  └─┘ |___/   \\___| └─┘","    > boop <          "], W),
    pad([" \\o/  ___  ___  \\o/ ","  │  | ω |---| ω |  │ ","  └─┘ |___/   \\___| └─┘","    > beep <          "], W),
  ],
  excited: [
    pad([" \\o/  ___  ___  \\o/ "," \\│/ | ◉ |---| ◉ | \\│/","  └─┘ |___/   \\___| └─┘","    !! ♥ !!           "], W),
    pad([" \\o/  ___  ___  \\o/ "," \\│/ | ◉ |---| ◉ | \\│/","  └─┘ |___/   \\___| └─┘","    BEEP BOOP!        "], W),
  ],
  sad: [
